...
#ifndef IGL_OPENGL_GLFW_IMGUI_Plugin_Menu_H
#define IGL_OPENGL_GLFW_IMGUI_Plugin_Menu_H
...
class Plugin_Menu : public igl::opengl::glfw::ViewerPlugin
{
protected:
...
#  include "plugins/plugin_menu.cpp"
#endif

#endif // IGL_OPENGL_GLFW_IMGUI_Plugin_Menu_H
